    ...
    @if(auth()->user()->hasRole('superadmin') || auth()->user()->hasRole('dewan guru') || auth()->user()->hasRole('rj1') || auth()->user()->hasRole('wk'))
      <li class="sidenav-item">
        ...
        <ul class="sidenav-collapse" aria-labelledby="navbarDropdownMenuLink-reporting">
          ...
          <li>
            <a class="sidenav-link" href="{{ route('penilaian') }}">
              <span class="sidenav-link-text ms-1">Penilaian</span>
            </a>
          </li>
          <li>
            <a class="sidenav-link" href="{{ route('view daily public presences recaps',[date('Y-m'),1]) }}">
              <span class="sidenav-link-text ms-1">Presensi Harian</span>
            </a>
          </li>
          <li>
            <a class="sidenav-link" href="#">
              <span class="sidenav-link-text ms-1">Presensi Hasda</span>
            </a>
          </li>
          <li>
            <a class="sidenav-link" href="#">
              <span class="sidenav-link-text ms-1">Agenda Bulanan</span>
            </a>
          </li>
        </ul>
      </li>
