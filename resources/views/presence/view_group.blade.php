  ...
  @if(isset($presenceGroup))
    ...
    <div class="card mt-4">
      <div class="card-header pb-0 d-flex justify-content-between align-items-center">
        ...
        <a href="{{ route('create presence in group', $presenceGroup->id) }}" class="btn btn-primary">
      ...
      <div class="card-body pt-4 p-3">
        ...
        <ul class="list-group">
          ...
          @if(sizeof($presenceGroup->presences()->paginate(5)) <= 0)
            Tidak ada hasil.
          @endif
          @foreach($presenceGroup->presences()->orderBy('event_date', 'DESC')->paginate(5) as $presence)
