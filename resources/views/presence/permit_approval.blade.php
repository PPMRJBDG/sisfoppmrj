@include('base.start', ['path' => 'presensi/izin/persetujuan', 'title' => 'Daftar Izin ' . (isset($lorong) ? $lorong->name : ''), 'breadcrumbs' => ['Daftar Izin', 'Daftar Izin ' . (isset($lorong) ? $lorong->name : '')]])  
  @if($santri && $lorong || auth()->user()->hasRole('rj1'))
    <div class="card">
