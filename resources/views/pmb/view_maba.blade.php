                                ...
                                <tbody>
                                    @foreach($camabas as $camaba)
                                        <tr class="text-sm">
                                            ...
                                            <td>
                                                <select class="form-control" id="mentor2-maba{{$camaba->id}}" name="mentor2" onchange="return changeMentor(2,{{$camaba->id}},this.value)">
                                                    <option value="">-- pilih mentor --</option>
                                                    @foreach($panitias as $panitia)
                                            ...
                                            <td>
                                                <select class="form-control" id="mentor3-maba{{$camaba->id}}" name="mentor3" onchange="return changeMentor(3,{{$camaba->id}},this.value)">
                                                    <option value="">-- pilih mentor --</option>
                                                    @foreach($panitias as $panitia)
                                        ...
                                        <tr class="text-sm">
                                            <td>
                                                <div style="line-height:1.6;">
                                                    ...
                                                    ?>
                                                    <select style="background:{{$bg_status}};" class="form-control" id="status-nilai-maba{{$camaba->id}}" name="status" onchange="return changeStatus({{$camaba->id}},this.value)">
                                                        <option {{ ($camaba->status=='pending') ? 'selected' : '' }} value="pending">PENDING</option>
                                                        <option {{ ($camaba->status=='interview') ? 'selected' : '' }} value="interview">INTERVIEW</option>
                                                        <option {{ ($camaba->status=='tes') ? 'selected' : '' }} value="tes">TES</option>
                                                        <option {{ ($camaba->status=='diterima') ? 'selected' : '' }} value="diterima">DITERIMA</option>
                                            ...
                                            <td>
                                                <select class="form-control" id="nilai-bacaan-maba{{$camaba->id}}" onchange="return changeNilai('bacaan',{{$camaba->id}},this.value)">
                                                ...
                                                <br>
                                                <input placeholder="Keterangan" class="form-control" type="text" value="{{$camaba->nilai_bacaan_ket}}" id="nilai-bacaan-ket{{$camaba->id}}" onkeyup="return changeNilai('bacaan_ket',{{$camaba->id}},this.value)">
                                                <br>
                                                <select class="form-control" id="nilai-bacaan-mentor{{$camaba->id}}" name="nilai-bacaan-mentor" onchange="return changeNilai('bacaan_mentor',{{$camaba->id}},this.value)">
                                                    <option value="">-- pilih mentor --</option>
                                                    @foreach($panitias as $panitia)
                                            ...
                                            <td>
                                                <select class="form-control" id="nilai-quran-maba{{$camaba->id}}" onchange="return changeNilai('penyampaian_quran',{{$camaba->id}},this.value)">
                                                ...
                                                <br>
                                                <input placeholder="Keterangan" class="form-control" type="text" value="{{$camaba->nilai_penyampaian_quran_ket}}" id="nilai-quran-ket{{$camaba->id}}" onkeyup="return changeNilai('penyampaian_quran_ket',{{$camaba->id}},this.value)">
                                                <br>
                                                <select class="form-control" id="nilai-quran-mentor{{$camaba->id}}" name="nilai-quran-mentor" onchange="return changeNilai('penyampaian_quran_mentor',{{$camaba->id}},this.value)">
                                                    <option value="">-- pilih mentor --</option>
                                                    @foreach($panitias as $panitia)
                                            ...
                                            <td>
                                                <select class="form-control" id="nilai-adzan-maba{{$camaba->id}}" onchange="return changeNilai('adzan',{{$camaba->id}},this.value)">
                                                ...
                                                <br>
                                                <input placeholder="Keterangan" class="form-control" type="text" value="{{$camaba->nilai_adzan_ket}}" id="nilai-adzan-ket{{$camaba->id}}" onkeyup="return changeNilai('adzan_ket',{{$camaba->id}},this.value)">
                                                <br>
                                                <select class="form-control" id="nilai-adzan-mentor{{$camaba->id}}" name="nilai-adzan-mentor" onchange="return changeNilai('adzan_mentor',{{$camaba->id}},this.value)">
                                                    <option value="">-- pilih mentor --</option>
                                                    @foreach($panitias as $panitia)
                                            ...
                                            <td>
                                                <select class="form-control" id="nilai-pegon-maba{{$camaba->id}}" onchange="return changeNilai('pegon',{{$camaba->id}},this.value)">
                                                    <option {{($camaba->nilai_bacaan=='-') ? 'selected' : ''}} value="-">-</option>
                                                ...
                                                <br>
                                                <input placeholder="Keterangan" class="form-control" type="text" value="{{$camaba->nilai_pegon_ket}}" id="nilai-pegon-ket{{$camaba->id}}" onkeyup="return changeNilai('pegon_ket',{{$camaba->id}},this.value)">
                                                <br>
                                                <select class="form-control" id="nilai-pegon-mentor{{$camaba->id}}" name="nilai-pegon-mentor" onchange="return changeNilai('pegon_mentor',{{$camaba->id}},this.value)">
                                                    <option value="">-- pilih mentor --</option>
                                                    @foreach($panitias as $panitia)
                                            ...
                                            <td>
                                                <select class="form-control" id="nilai-wawancara-maba{{$camaba->id}}" onchange="return changeNilai('wawancara',{{$camaba->id}},this.value)">
                                                    <option {{($camaba->nilai_bacaan=='-') ? 'selected' : ''}} value="-">-</option>
                                                ...
                                                <br>
                                                <input placeholder="Keterangan" class="form-control" type="text" value="{{$camaba->nilai_wawancara_ket}}" id="nilai-wawancara-ket{{$camaba->id}}" onkeyup="return changeNilai('wawancara_ket',{{$camaba->id}},this.value)">
                                                <br>
                                                <select class="form-control" id="nilai-wawancara-mentor{{$camaba->id}}" name="nilai-wawancara-mentor" onchange="return changeNilai('wawancara_mentor',{{$camaba->id}},this.value)">
                                                    <option value="">-- pilih mentor --</option>
                                                    @foreach($panitias as $panitia)
