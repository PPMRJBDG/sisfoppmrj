@include('base.start', ['path' => 'lorong/saya', 'title' => $lorong ? $lorong->name : 'Lorong tidak ditemukan', 'breadcrumbs' => ['Daftar Lorong', $lorong ? $lorong->name : 'Lorong tidak ditemukan']])
  @if(isset($lorong))
  <div class="card">
