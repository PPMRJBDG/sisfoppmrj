...
Route::get('/presensi/izin/persetujuan/{tb}', [App\Http\Controllers\PresenceController::class, 'permit_approval'])->name('presence permit approval')->middleware('permission:approve permits');
